...
//    xil_printf("HDMI Setup Complete!\r\n");
    ...
    Xil_Out32(XPAR_AXI_VDMA_0_BASEADDR + 0xB0, 0x11000000);
    Xil_Out32(XPAR_AXI_VDMA_0_BASEADDR + 0xB4, 0x12000000);
    ...
    Xil_Out32(XPAR_AXI_VDMA_0_BASEADDR + 0x60, 0x11000000);
    Xil_Out32(XPAR_AXI_VDMA_0_BASEADDR + 0x64, 0x12000000);
